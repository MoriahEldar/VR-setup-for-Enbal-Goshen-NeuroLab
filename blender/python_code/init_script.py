...
def init_rewards():
    ...
    if '--' in args:
        ...
        print("BLENDER: got rewards from command line: " + str(start_obj['rewards']))
...
def init_java_socket(): 
    ...
    print("BLENDER: trying to connect to java program")
    client_socket, addr = server_socket.accept() # works? knows how to wait?
    print("BLENDER: connected to java program")
